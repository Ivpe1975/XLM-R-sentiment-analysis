...
df_es["sestimest"] = df_es["stars"].apply(lambda x: 0 if x < 3 else 1)
...
df_zh["szhtimzht"] = df_zh["stars"].apply(lambda x: 0 if x < 3 else 1)
...
# print('f_1 for German from English:', acc_de, '\n', 'f_1 for Japanese from English:', acc_ja, '\n', 'f_1 for French from English:', acc_fr, '\n', 'f_1 for English from English:', acc_en, '\n')

with open('results_test.txt','w+') as results:
    results.write('f_1 for German from English: '+ str(acc_de)+'\n')
    results.write('f_1 for Japanese from English: '+ str(acc_ja)+'\n')
    results.write('f_1 for French from English:'+ str(acc_fr)+'\n')
    results.write('f_1 for English from English:'+str(acc_en)+ '\n')
