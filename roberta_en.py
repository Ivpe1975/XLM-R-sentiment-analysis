...
df = pd.read_json("json/train/dataset_en_train.json", orient="records", lines=True)
...
with open('results_en.txt','w+') as results:
    results.write('f_1 for German from English: ' + str(f1_score_de)+'\n')
    results.write('f_1 for Japanese from English: ' + str(f1_score_ja)+'\n')
    results.write('f_1 for French from English:' + str(f1_score_fr)+'\n')
    results.write('f_1 for English from English:' + str(f1_score_en)+ '\n')
    results.write('f_1 for Spanish from English:' + str(f1_score_es)+ '\n')
    results.write('f_1 for Chinese from English:' + str(f1_score_zh)+ '\n')

    results.write('Precision for German from English: ' + str(precision_de)+'\n')
    results.write('Precision for Japanese from English: ' + str(precision_ja)+'\n')
    results.write('Precision for French from English:' + str(precision_fr)+'\n')
    results.write('Precision for English from English:' + str(precision_en)+ '\n')
    results.write('Precision for Spanish from English:' + str(precision_es)+ '\n')
    results.write('Precision for Chinese from English:' + str(precision_zh)+ '\n')

    results.write('Recall for German from English: ' + str(recall_de)+'\n')
    results.write('Recall for Japanese from English: ' + str(recall_ja)+'\n')
    results.write('Recall for French from English:' + str(recall_fr)+'\n')
    results.write('Recall for English from English:' + str(recall_en)+ '\n')
    results.write('Recall for Spanish from English:' + str(recall_es)+ '\n')
    results.write('Recall for Chinese from English:' + str(recall_zh)+ '\n')

    results.write('Accuracy for German from English: ' + str(epoch_accu_de)+'\n')
    results.write('Accuracy for Japanese from English: ' + str(epoch_accu_ja)+'\n')
    results.write('Accuracy for French from English:' + str(epoch_accu_fr)+'\n')
    results.write('Accuracy for English from English:' + str(epoch_accu_en)+ '\n')
    results.write('Accuracy for Spanish from English:' + str(epoch_accu_es)+ '\n')
    results.write('Accuracy for Chinese from English:' + str(epoch_accu_zh)+ '\n')


output_model_file = 'pytorch_roberta_en.bin'
output_vocab_file = 'en_vocab/'
