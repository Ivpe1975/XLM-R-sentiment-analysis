...
df = pd.read_json("json/train/dataset_ja_train.json", orient="records", lines=True)
...
def valid(model, testing_loader):
    ...
    return f1_score,precision,recall,epoch_accu
...
f1_score_en, precision_en, recall_en, epoch_accu_en = valid(model, testing_loader_en)
...
with open('results_ja.txt','w+') as results:
    results.write('f_1 for German from Japanese: ' + str(f1_score_de)+'\n')
    results.write('f_1 for Japanese from Japanese: ' + str(f1_score_ja)+'\n')
    results.write('f_1 for French from Japanese:' + str(f1_score_fr)+'\n')
    results.write('f_1 for English from Japanese:' + str(f1_score_en)+ '\n')
    results.write('f_1 for Spanish from Japanese:' + str(f1_score_es)+ '\n')
    results.write('f_1 for Chinese from Japanese:' + str(f1_score_zh)+ '\n')

    results.write('Precision for German from Japanese: ' + str(precision_de)+'\n')
    results.write('Precision for Japanese from Japanese: ' + str(precision_ja)+'\n')
    results.write('Precision for French from Japanese:' + str(precision_fr)+'\n')
    results.write('Precision for English from Japanese:' + str(precision_en)+ '\n')
    results.write('Precision for Spanish from Japanese:' + str(precision_es)+ '\n')
    results.write('Precision for Chinese from Japanese:' + str(precision_zh)+ '\n')

    results.write('Recall for German from Japanese: ' + str(recall_de)+'\n')
    results.write('Recall for Japanese from Japanese: ' + str(recall_ja)+'\n')
    results.write('Recall for French from Japanese:' + str(recall_fr)+'\n')
    results.write('Recall for English from Japanese:' + str(recall_en)+ '\n')
    results.write('Recall for Spanish from Japanese:' + str(recall_es)+ '\n')
    results.write('Recall for Chinese from Japanese:' + str(recall_zh)+ '\n')

    results.write('Accuracy for German from Japanese: ' + str(epoch_accu_de)+'\n')
    results.write('Accuracy for Japanese from Japanese: ' + str(epoch_accu_ja)+'\n')
    results.write('Accuracy for French from Japanese:' + str(epoch_accu_fr)+'\n')
    results.write('Accuracy for English from Japanese:' + str(epoch_accu_en)+ '\n')
    results.write('Accuracy for Spanish from Japanese:' + str(epoch_accu_es)+ '\n')
    results.write('Accuracy for Chinese from Japanese:' + str(epoch_accu_zh)+ '\n')


output_model_file = 'pytorch_roberta_ja.bin'
output_vocab_file = 'ja_vocab/'
