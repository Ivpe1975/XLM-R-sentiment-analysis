...
df = pd.read_json("json/train/dataset_es_train.json", orient="records", lines=True)
...
with open('results_es.txt','w+') as results:
    results.write('f_1 for German from Spanish: ' + str(f1_score_de)+'\n')
    results.write('f_1 for Japanese from Spanish: ' + str(f1_score_ja)+'\n')
    results.write('f_1 for French from Spanish:' + str(f1_score_fr)+'\n')
    results.write('f_1 for English from Spanish:' + str(f1_score_en)+ '\n')
    results.write('f_1 for Spanish from Spanish:' + str(f1_score_es)+ '\n')
    results.write('f_1 for Chinese from Spanish:' + str(f1_score_zh)+ '\n')

    results.write('Precision for German from Spanish: ' + str(precision_de)+'\n')
    results.write('Precision for Japanese from Spanish: ' + str(precision_ja)+'\n')
    results.write('Precision for French from Spanish:' + str(precision_fr)+'\n')
    results.write('Precision for English from Spanish:' + str(precision_en)+ '\n')
    results.write('Precision for Spanish from Spanish:' + str(precision_es)+ '\n')
    results.write('Precision for Chinese from Spanish:' + str(precision_zh)+ '\n')

    results.write('Recall for German from Spanish: ' + str(recall_de)+'\n')
    results.write('Recall for Japanese from Spanish: ' + str(recall_ja)+'\n')
    results.write('Recall for French from Spanish:' + str(recall_fr)+'\n')
    results.write('Recall for English from Spanish:' + str(recall_en)+ '\n')
    results.write('Recall for Spanish from Spanish:' + str(recall_es)+ '\n')
    results.write('Recall for Chinese from Spanish:' + str(recall_zh)+ '\n')

    results.write('Accuracy for German from Spanish: ' + str(epoch_accu_de)+'\n')
    results.write('Accuracy for Japanese from Spanish: ' + str(epoch_accu_ja)+'\n')
    results.write('Accuracy for French from Spanish:' + str(epoch_accu_fr)+'\n')
    results.write('Accuracy for English from Spanish:' + str(epoch_accu_en)+ '\n')
    results.write('Accuracy for Spanish from Spanish:' + str(epoch_accu_es)+ '\n')
    results.write('Accuracy for Chinese from Spanish:' + str(epoch_accu_zh)+ '\n')


output_model_file = 'pytorch_roberta_es.bin'
output_vocab_file = 'es_vocab/'
